...
_Container ZSU_EXPORT strip_left_if(_Container __container, _Predicate __pred)
{
  _Container::iterator from(std::find_if(__container.begin(), __container.end(), std::not1(__pred)));
 ...
 */
template <class _Container, class _Predicate>
_Container ZSU_EXPORT strip_right_if(_Container __container, _Predicate __pred)
{
  _Container::reverse_iterator from(std::find_if(__container.rbegin(), __container.rend(), std::not1(__pred)));
 ...
 */
template <class _Container, class _Predicate>
_Container ZSU_EXPORT strip_if(_Container __container, _Predicate __pred)
{
