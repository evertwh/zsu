...
namespace zsu
{
  ...
  /** string escape function.
    ...
    Escapes special characters in a string using the 'C' convention.
      ...
      @see unEscape()
  */
  std::string ZSU_EXPORT escape(const std::string& str);
  ...
  /** string un-escape function.
    ...
    simply be removed from the string.
      ...
      @see escape()
  */
  std::string ZSU_EXPORT unEscape(const std::string& str);
  ...
  */
  std::string ZSU_EXPORT quote(const std::string& str);
  ...
  */
  std::string ZSU_EXPORT unQuote(const std::string& str);
  ...
  /** read quoted string from a stream.
    ...
    returns false immediately.
      ...
      @see escape(), unEscape()
  */
  bool ZSU_EXPORT readQuoted(std::string& str, std::istream& is);
  ...
  */
  void ZSU_EXPORT readString(std::string& str, std::istream& is, char delim = 0);
  ...
  */
  bool ZSU_EXPORT checkKey(const std::string& key, std::istream& is);
  ...
  */
  bool ZSU_EXPORT startList(const std::string& key, std::istream& is);
  ...
  */
  bool ZSU_EXPORT readEntry(const std::string& key, std::string& value, std::istream& is);
  ...
  /** reads the value in a [ key = "value" ] header.
    ...
    intended to start top level sections in OM files.
      ...
      @see readEntry
  */
  bool ZSU_EXPORT readSection(const std::string& key, std::string& value,
      std::istream& is);
  ...
  /** reads a list of values in a key={value1 value2 } entry.
    ...
    in the list will be appended to the values vector.
      ...
      @see checkKey(), quote(), unEscape()
  */
  bool ZSU_EXPORT readEntry(const std::string& key, std::vector<std::string>& values,
      std::istream& is);
  ...
  /** reads the numeric value in a key=value pair.
    ...
    Reads the value in a 'key=value' pair. The value has to be numeric.
      ...
      @see checkKey(), quote()
  */
  bool ZSU_EXPORT readEntry(const std::string& key, double& value, std::istream& is);
  ...
  /** reads the numeric value in a key=value pair.
    ...
    Reads the value in a 'key=value' pair. The value has to be numeric.
      ...
      @see checkKey(), quote()
  */
  bool ZSU_EXPORT readEntry(const std::string& key, int& value, std::istream& is);
  ...
  /** reads a list of numeric values in a key={value1 value2 } entry.
    ...
    appended to the values vector.
      ...
      @see checkKey(), quote()
  */
  bool ZSU_EXPORT readEntry(const std::string& key, std::vector<double>& values,
      std::istream& is);
  ...
  /** reads a list of numeric values in a key={value1 value2 } entry.
    ...
    appended to the values vector.
      ...
      @see checkKey(), quote()
  */
  bool ZSU_EXPORT readEntry(const std::string& key, std::vector<int>& values,
      std::istream& is);
  ...
  /** reads a list of values in the format {value1 value2 } entry.
    ...
    in the list will be appended to the values vector.
      ...
      @see quote(), unEscape()
  */
  bool ZSU_EXPORT readList(std::vector<std::string>& values, std::istream& is);
  ...
  /** write quoted string to a stream.
    ...
    Quotes a string and writes it to a stream.
      ...
      @see quote()
  */
  void ZSU_EXPORT writeQuoted(const std::string& str, std::ostream& os);
  ...
  */
  void ZSU_EXPORT writeKey(const std::string& key, std::ostream& os);
  ...
  /** writes the key and value in a key=value pair.
    ...
    Writes a 'key=value' pair. The value will be quoted and escaped.
      ...
      @see writeKey(), quote()
  */
  void ZSU_EXPORT writeEntry(const std::string& key, const std::string& value,
      std::ostream& os);
  ...
  /** writes a list of values in a #key={value1 value2 }# entry.
    ...
    The values will be quoted and escaped.
      ...
      @param os reference to the stream that will be written to
  */
  void ZSU_EXPORT writeEntry(const std::string& key,
  ...
  /** writes a key=value pair for a numeric value.
    ...
    @param os reference to the stream that will be written to
  */
  void ZSU_EXPORT writeEntry(const std::string& key, double value, std::ostream& os);
  ...
  /** writes a key=value pair for a numeric value.
    ...
    @param os reference to the stream that will be written to
  */
  void ZSU_EXPORT writeEntry(const std::string& key, int value, std::ostream& os);
  ...
  /** writes a list of numeric values in a #key={value1 value2 }# entry.
    ...
    @param os reference to the stream that will be written to
  */
  void ZSU_EXPORT writeEntry(const std::string& key, const std::vector<double>& values,
      std::ostream& os);
  ...
  */
  std::string ZSU_EXPORT strip(std::string str);
  ...
  */
  //std::string ZSU_EXPORT strip(std::string str, std::string quotes);

  /**
  Case insensitive comparison of two standard strings.
  */
  int ZSU_EXPORT compareCaseInsensitive(std::string a, std::string b);

  /// Convert string to lower case
  std::string ZSU_EXPORT toLower(std::string text);

  /// Convert string to upper case
  std::string ZSU_EXPORT toUpper(std::string text);
  ...
  */
  std::string ZSU_EXPORT toProperCase(std::string text);
   ...
   */
  std::string ZSU_EXPORT maskedSubstr(std::string str, std::string mask, char passThrough);
   ...
   */
  std::string ZSU_EXPORT removeMatchingQuotes(std::string str);

  /**
    Removes all occurences of @padding from the left of @str.
   */
  std::string ZSU_EXPORT stripLeft(std::string str, char padding);
  /**
    Removes all occurences of @padding from the right of @str.
   */
  std::string ZSU_EXPORT stripRight(std::string str, char padding);
  /**
    Removes all occurences of @padding from the left and right of @str.
   */
  std::string ZSU_EXPORT strip(std::string str, char padding);

  /**
    Removes all whitespace from the left of @str.
   */
  std::string ZSU_EXPORT stripLeft(std::string str);
  /**
    Removes all whitespace from the right of @str.
   */
  std::string ZSU_EXPORT stripRight(std::string str);
  /**
